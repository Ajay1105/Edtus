...
const Features = () => {
  return (
    <div className="flex justify-center align-middle items-center">
      <div className="py-4 px-6 bg-[#4883FF] w-[100vw] -mx-10 -px-10 flex flex-col justify-center items-center align-middle">
        Our Features
        <p className="py-4">
          Fostering a playful & engaging learning environment
        </p>
        <div className="flex flex-row flex-wrap">
          <div className="flex flex-col w-56 mx-5 md:mx-16 justify-center items-center align-middle">
