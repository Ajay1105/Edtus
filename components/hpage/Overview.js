const OverviewContainer = () => {
  return (
    <div className="absolute top-[3180px] left-[0px] bg-gray1-300 w-[1440px] flex flex-col items-start justify-start text-left text-sm text-darkgray font-text-lg-semibold">
      <div className="self-stretch flex flex-col items-center justify-start pt-16 px-0 pb-12">
          ...
          <div className="self-stretch flex flex-row items-start justify-start">
            <div className="flex-1 flex flex-row items-start justify-start gap-[32px]">
              <div className="flex-1 flex flex-col items-start justify-start gap-[16px]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[12px] text-base text-gray-200">
              ...
              <div className="flex-1 flex flex-col items-start justify-start gap-[16px]">
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[12px] text-base text-gray-200">
                  ...
                  <div className="flex flex-row items-center justify-start gap-[8px]">
                    ...
                    <div className="flex flex-row items-start justify-start mix-blend-normal text-center text-xs text-gray1-100">
                      <div className="rounded-2xl bg-whitesmoke flex flex-row items-center justify-center py-0.5 px-2">
      ...
      <div className="self-stretch bg-gray1-400 flex flex-col items-center justify-start py-12 px-0 text-base">
        <div className="flex flex-col items-start justify-start py-0 px-8">
